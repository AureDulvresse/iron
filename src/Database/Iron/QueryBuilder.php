...
class QueryBuilder
{
    ...
    /**
     * Jointures de type INNER JOIN entre tables.
     * @param string $table
     ...
     * @return \Forge\Database\Iron\QueryBuilder
     */
    public function join(string $table, string $localKey, string $operator, string $foreignKey): self
    {
        $this->joins .= " INNER JOIN $table ON $localKey $operator $foreignKey";
        return $this;
    }


    /**
     * Jointures de type LEFT JOIN entre tables.
     * @param string $table
     * @param string $localKey
     * @param string $operator
     * @param string $foreignKey
     * @return \Forge\Database\Iron\QueryBuilder
     */
    public function leftJoin(string $table, string $localKey, string $operator, string $foreignKey): self
    {
    ...
    /**
     * Jointures de type RIGHT JOIN entre tables.
     * @param string $table
     * @param string $localKey
     * @param string $operator
     * @param string $foreignKey
     * @return \Forge\Database\Iron\QueryBuilder
     */
    public function rightJoin(string $table, string $localKey, string $operator, string $foreignKey): self
    {
